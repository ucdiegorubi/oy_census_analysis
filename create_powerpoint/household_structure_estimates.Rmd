...
### Median Income YY Reference Person by PUMA
...
analysis_data$median_income_hh_by_puma_region %>% 
  ...
  labs(y = "Median Income", 
       ...
       title = "Median income of reference person for Connected Youth by Chicago region") + 
  theme(
...
### Most Connected Youth are commute twenty minutes or less to their employer
