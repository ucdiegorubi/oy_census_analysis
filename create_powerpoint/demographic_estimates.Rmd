  ...
  labs(
    ...
    caption = 
      str_wrap("*A subset of the population of 16-24 year olds is not captured as either Opportunity Youth or Connected Youth due to missing responses in the data. ", 
               width = 80), 
    title = "Percentage of youth that are Opportunity Youth"
  ) + 
  scale_y_continuous(labels = scales::percent) 
```
...
analysis_data$q1_demographics$oy_race_alternate %>% 
  ...
  labs(x = "", 
       ...
       title = "Race or Ethnicity of Youth group"
       ) + 
  scale_y_continuous(labels = scales::percent) + 
  theme_classic() + 
  theme(
...
analysis_data$q1_demographics$oy_sex %>% 
  ...
  labs(x = "Percentage of individuals between 16-24 who identify as male", 
       ...
       title = "Gender identity of youth group") + 
  scale_y_continuous(labels = scales::percent) + 
  theme_classic() + 
  theme(
...
analysis_data$q1_demographics$oy_disability %>% 
  ...
  labs(x =  "Percentage of individuals between 16-24 that report having a disability", 
       ...
       title = "Disability status of youth groups") + 
  scale_y_continuous(labels = scales::percent) + 
  theme_classic() + 
  theme(
    legend.position = 'bottom'
...
analysis_data$q1_demographics$oy_edu_attainment %>% 
  ...
  labs(
    ...
    title = 'Educational attainment by youth group'
  ) + 
  ...
  scale_y_continuous(labels = scales::percent) +
  guides(fill = guide_legend(title = "Primary Plan",
...
analysis_data$q1_demographics$geo_puma_pop_percent %>% 
  ...
  labs(fill = 
       ...
       title = "Distribution of Opportunity Youth by PUMA") + 
  scale_y_continuous(labels = scales::percent)
...
## Southside connected youth are less likely to be employed
...
plot_chart <- 
  ...
  labs(y = "Percent", 
       x = "PUMA", 
       fill = "Chicago Region", 
       title = "Connected Youth employment by PUMA") + 
  theme(
    legend.position = 'bottom'
  ) +
  ggsci::scale_fill_uchicago() + 
...
## Westside connected youth are less likely to be enrolled in school 
...
plot_chart <- 
  ...
  labs(y = "Percent", 
       x = "PUMA", 
       fill = "Chicago Region", 
       title = "Connected Youth school enrollment by PUMA") + 
  theme(
    legend.position = 'bottom'
  ) +
  ggsci::scale_fill_uchicago() + 
